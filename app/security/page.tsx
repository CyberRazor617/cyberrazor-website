...
export default function SecurityProtocolsPage() {
  ...
  return (
    <div className={cn("min-h-screen bg-black text-white relative security-page", orbitron.variable)} style={{ backgroundColor: '#000000' }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3 text-slate-400 font-orbitron font-light text-sm sm:text-base">
                ...
                <li>
                  <button onClick={() => router.push('/security/protocols')} className="hover:text-blue-400 transition-colors text-blue-400">
                    Security Protocols
                  </button>
                </li>
              </ul>
